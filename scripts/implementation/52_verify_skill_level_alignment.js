/**
 * Verification Script: 52_verify_skill_level_alignment.js
 * Purpose: Read-only checks for skill level type alignment.
 *
 * Run via: Scripts - Background (Global scope)
 */
(function() {
    var PREFIX = '[Skills Hub Level Verify] ';
    var passed = 0;
    var failed = 0;
    var warned = 0;
    ...
    if (profile) {
        ...
        checkContains('My Profile template', profile.getValue('template'), 'level_label');
    } else {
